...
var JSNamespace = (function(){
	...
	JSNamespace.getNamespaceObjectLiteral = function(namespaceObject)
	{
		for(var namespace in this.resolvedChildNamespace)
		{
			var childNamespaceObject = {};
			var childNamespace = this.resolvedChildNamespace[namespace];
